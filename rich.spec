...
%prep
%setup -q -n rich-10.16.0
cd %{_builddir}/rich-10.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639423298
...
cp %{_builddir}/rich-10.16.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
