...
Source0  : https://files.pythonhosted.org/packages/12/3c/e4e2b356057f3ce557fcda8a2b9bf114b06f71ade88dac8a0883ae800e28/rich-10.1.0.tar.gz
...
%prep
%setup -q -n rich-10.1.0
cd %{_builddir}/rich-10.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617639303
...
cp %{_builddir}/rich-10.1.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
