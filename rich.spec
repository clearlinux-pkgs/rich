...
Source0  : https://files.pythonhosted.org/packages/09/a4/4d197cad5b8e85085e6593628131bd0fec903c1f61e158326d80cd6c1c6b/rich-10.15.1.tar.gz
...
%prep
%setup -q -n rich-10.15.1
cd %{_builddir}/rich-10.15.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638368981
...
cp %{_builddir}/rich-10.15.1/LICENSE %{buildroot}/usr/share/package-licenses/rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
