...
Source0  : https://files.pythonhosted.org/packages/b3/3b/5a90d0f197087896472757ebd9ac29d802ccc4f6953d99a535b1a8db2bf6/rich-10.16.1.tar.gz
...
%prep
%setup -q -n rich-10.16.1
cd %{_builddir}/rich-10.16.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639584594
...
cp %{_builddir}/rich-10.16.1/LICENSE %{buildroot}/usr/share/package-licenses/rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
