...
Source0  : https://files.pythonhosted.org/packages/39/4d/f36162a44a54ba07a04efb9eaf7e6dd726245198cf5a335b97bdad92cd08/rich-9.6.2.tar.gz
...
%prep
%setup -q -n rich-9.6.2
cd %{_builddir}/rich-9.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610069857
...
cp %{_builddir}/rich-9.6.2/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
