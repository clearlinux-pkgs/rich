...
Source0  : https://files.pythonhosted.org/packages/27/b5/c50ca2874332a3eeba556976c4be2d948402d64a94e8fa7be9376361032d/rich-9.5.0.tar.gz
...
%prep
%setup -q -n rich-9.5.0
cd %{_builddir}/rich-9.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608317514
...
cp %{_builddir}/rich-9.5.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
