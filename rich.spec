...
Source0  : https://files.pythonhosted.org/packages/1e/cc/ced09195051b5384e9a82d6de7fc1a3917017fe214d30d41a9935cea465d/rich-10.2.2.tar.gz
...
%prep
%setup -q -n rich-10.2.2
cd %{_builddir}/rich-10.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621450023
...
cp %{_builddir}/rich-10.2.2/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
