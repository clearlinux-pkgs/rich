...
Source0  : https://files.pythonhosted.org/packages/1d/61/e06f30b1f3c16634ad2b12ef1f42ec218793ebe593d6c36b43202d1a6683/rich-10.0.1.tar.gz
...
%prep
%setup -q -n rich-10.0.1
cd %{_builddir}/rich-10.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617215502
...
cp %{_builddir}/rich-10.0.1/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
