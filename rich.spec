...
Source0  : https://files.pythonhosted.org/packages/ad/71/849f1bb4d11d5d47756e76e3d0d41970dc5134b3d6e02af224d56a4913b8/rich-10.2.0.tar.gz
...
%prep
%setup -q -n rich-10.2.0
cd %{_builddir}/rich-10.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620920283
...
cp %{_builddir}/rich-10.2.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
