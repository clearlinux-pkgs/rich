...
Source0  : https://files.pythonhosted.org/packages/93/41/79e947ce1e2e6132afcc13e617b2c1bcce90f481cf78e652f8c986b19162/rich-10.5.0.tar.gz
...
%prep
%setup -q -n rich-10.5.0
cd %{_builddir}/rich-10.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625589383
...
cp %{_builddir}/rich-10.5.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
