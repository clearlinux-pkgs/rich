...
Source0  : https://files.pythonhosted.org/packages/8c/65/8743a4b98585dbebf943aa8d8d30421606b492decfde9b8ffc3d5812a791/rich-9.10.0.tar.gz
...
%prep
%setup -q -n rich-9.10.0
cd %{_builddir}/rich-9.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611800971
...
cp %{_builddir}/rich-9.10.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
