...
Source0  : https://files.pythonhosted.org/packages/67/47/765d57cdd54d74d2a70de26d7ffad1109745f14f3c425015905e6749d3b9/rich-9.7.0.tar.gz
...
%prep
%setup -q -n rich-9.7.0
cd %{_builddir}/rich-9.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610302146
...
cp %{_builddir}/rich-9.7.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
