...
Source0  : https://files.pythonhosted.org/packages/35/db/03d231a226ef672b1e6f1aa10c71284666d2141cc6f4a19188c6cbb4b64d/rich-10.0.0.tar.gz
...
%prep
%setup -q -n rich-10.0.0
cd %{_builddir}/rich-10.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617035281
...
cp %{_builddir}/rich-10.0.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
