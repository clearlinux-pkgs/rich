...
Source0  : https://files.pythonhosted.org/packages/91/2a/557d387c3f2d86ff5ac9d8c8cabec6f00b4eaeaa0e234c0ffe7bbe0be973/rich-9.6.1.tar.gz
...
%prep
%setup -q -n rich-9.6.1
cd %{_builddir}/rich-9.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609974150
...
cp %{_builddir}/rich-9.6.1/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
