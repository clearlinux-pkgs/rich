...
Source0  : https://files.pythonhosted.org/packages/55/d0/bbb5c4ce2345173badac1415881b33d0253f07b8c3c7edf92c53b9e7cbde/rich-9.12.0.tar.gz
...
%prep
%setup -q -n rich-9.12.0
cd %{_builddir}/rich-9.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614269498
...
cp %{_builddir}/rich-9.12.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
