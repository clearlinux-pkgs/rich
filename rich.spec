...
Source0  : https://files.pythonhosted.org/packages/8f/47/492527c7c1f0e876f2d64669f941a81b81e1e87eb8982892acca179998bf/rich-9.12.3.tar.gz
...
%prep
%setup -q -n rich-9.12.3
cd %{_builddir}/rich-9.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614624315
...
cp %{_builddir}/rich-9.12.3/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
