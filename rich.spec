...
Source0  : https://files.pythonhosted.org/packages/d3/09/e30866c844516d4f15e5b0c436250aaa17a94cc41cf33df2eac78af4243f/rich-10.14.0.tar.gz
...
%prep
%setup -q -n rich-10.14.0
cd %{_builddir}/rich-10.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637088904
...
cp %{_builddir}/rich-10.14.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
