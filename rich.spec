...
Source0  : https://files.pythonhosted.org/packages/5a/2d/5e92c69f971cb2a373a5203fe2ff0a06751b3eea918c709318e19f7caf62/rich-9.9.0.tar.gz
...
%prep
%setup -q -n rich-9.9.0
cd %{_builddir}/rich-9.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611428112
...
cp %{_builddir}/rich-9.9.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
