...
Source0  : https://files.pythonhosted.org/packages/fb/96/b268c7ac622597f8660e14e01d8b66b84a34fbbaed3b920bfca440f742fe/rich-9.8.2.tar.gz
...
%prep
%setup -q -n rich-9.8.2
cd %{_builddir}/rich-9.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610732805
...
cp %{_builddir}/rich-9.8.2/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
