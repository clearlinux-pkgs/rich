...
Source0  : https://files.pythonhosted.org/packages/af/69/0bb9f0807085ce91ad0847d191567257aac180a5960c75c17f43d9ede060/rich-10.2.1.tar.gz
...
%prep
%setup -q -n rich-10.2.1
cd %{_builddir}/rich-10.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621299086
...
cp %{_builddir}/rich-10.2.1/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
