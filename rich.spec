...
Source0  : https://files.pythonhosted.org/packages/d3/05/8ea30e5c3cc614eaa390479149ee44408294cab4e2a37ee51c0526a54632/rich-9.0.1.tar.gz
...
%prep
%setup -q -n rich-9.0.1
cd %{_builddir}/rich-9.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603333854
...
cp %{_builddir}/rich-9.0.1/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
