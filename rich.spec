...
Source0  : https://files.pythonhosted.org/packages/72/f5/1f06eb039318ae8eb4d13e4abe52dd0b1fdd466b35cf9e52a2e505509532/rich-10.6.0.tar.gz
...
%prep
%setup -q -n rich-10.6.0
cd %{_builddir}/rich-10.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626189795
...
cp %{_builddir}/rich-10.6.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
