...
Source0  : https://files.pythonhosted.org/packages/6b/ea/af2a2218d57cc52dc7f14e4350ee9647fa79c6c820cfc05c438795fb13b4/rich-10.7.0.tar.gz
...
%prep
%setup -q -n rich-10.7.0
cd %{_builddir}/rich-10.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628213645
...
cp %{_builddir}/rich-10.7.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
