...
Source0  : https://files.pythonhosted.org/packages/c7/dd/634c0474026b323cddd9b38939e40b502d04eebd36b47d994d4919de5d4c/rich-9.8.1.tar.gz
...
%prep
%setup -q -n rich-9.8.1
cd %{_builddir}/rich-9.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610579077
...
cp %{_builddir}/rich-9.8.1/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
