...
Source0  : https://files.pythonhosted.org/packages/55/84/7edede78686a4ca67a1bb9d8eba31a99d4a2a0a670e80c9febbbc18a7076/rich-10.9.0.tar.gz
...
%prep
%setup -q -n rich-10.9.0
cd %{_builddir}/rich-10.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630340782
...
cp %{_builddir}/rich-10.9.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
