...
Source0  : https://files.pythonhosted.org/packages/38/93/fdad196d6c58a541bf1d34db17f677e24f71cbd8bc746ed58f418cddf2ad/rich-9.8.0.tar.gz
...
%prep
%setup -q -n rich-9.8.0
cd %{_builddir}/rich-9.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610468156
...
cp %{_builddir}/rich-9.8.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
