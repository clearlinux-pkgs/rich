...
Source0  : https://files.pythonhosted.org/packages/ae/f6/6ffb46f6cf0bb584e44279accd3321cb838b78b324031feb8fd9adf63ed2/rich-9.13.0.tar.gz
...
%prep
%setup -q -n rich-9.13.0
cd %{_builddir}/rich-9.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615220343
...
cp %{_builddir}/rich-9.13.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
