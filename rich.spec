...
Source0  : https://files.pythonhosted.org/packages/e0/f4/df55dc69153e1d67525f1663aec11da8db80d281a4400810a4cbbd6af251/rich-9.12.4.tar.gz
...
%prep
%setup -q -n rich-9.12.4
cd %{_builddir}/rich-9.12.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614785934
...
cp %{_builddir}/rich-9.12.4/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
