...
Source0  : https://files.pythonhosted.org/packages/6a/d2/c8a097b27269ec7e759c9f6b505c35750602ed00d832034ab1dd90629c4d/rich-9.11.1.tar.gz
...
%prep
%setup -q -n rich-9.11.1
cd %{_builddir}/rich-9.11.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614016542
...
cp %{_builddir}/rich-9.11.1/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
