...
Source0  : https://files.pythonhosted.org/packages/42/6e/549283c6f8b9fff54ee8bd35558eb51d3796b1f71509d3385011d9a8c857/rich-10.3.0.tar.gz
...
%prep
%setup -q -n rich-10.3.0
cd %{_builddir}/rich-10.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623268985
...
cp %{_builddir}/rich-10.3.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
