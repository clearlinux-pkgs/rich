...
Source0  : https://files.pythonhosted.org/packages/2f/b7/b8b950458f88c6d74978a37ad1d1fb9885464372fcb3d4077c2d9186a5c3/rich-10.4.0.tar.gz
...
%prep
%setup -q -n rich-10.4.0
cd %{_builddir}/rich-10.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624058152
...
cp %{_builddir}/rich-10.4.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
