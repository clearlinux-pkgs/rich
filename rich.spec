...
Source0  : https://files.pythonhosted.org/packages/4e/fd/5d40b0363467f8c87d5f5f551b7b431e234bff2becf959daab453f9d7795/rich-10.12.0.tar.gz
...
%prep
%setup -q -n rich-10.12.0
cd %{_builddir}/rich-10.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633534183
...
cp %{_builddir}/rich-10.12.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
