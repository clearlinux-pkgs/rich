...
Source0  : https://files.pythonhosted.org/packages/7c/7b/aa24eb7b8a7cd3d974ca47e9a95a9d462856543162944658689a07d665c5/rich-9.1.0.tar.gz
...
%prep
%setup -q -n rich-9.1.0
cd %{_builddir}/rich-9.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603749085
...
cp %{_builddir}/rich-9.1.0/LICENSE %{buildroot}/usr/share/package-licenses/rich/aaba1270952b5954329751066884531f753f798f
